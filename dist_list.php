<?php require("c:/inetpub/libs/kansasstatetreasurer/lib_dist_list_top01.php");  ?><!DOCTYPE html>
<html >
<head>
  ...
  <meta name="description" content="Results list from the criteria entered on the Distributions Search page.">
  ...
  <link rel="stylesheet" href="assets/css/dist_list.css"  type="text/css">
<script type="text/javascript" src="/jquery/jquery-3.2.1.min.js"></script>
<script type="text/javascript" src="assets/js/dist_list.js"></script>

<script src='https://www.google.com/recaptcha/api.js'></script>
</head>
<body>
<section class="menu cid-qEt7xbDHf1" once="menu" id="menu1-5w" data-rv-view="1244">
...
<section class="engine"><a href="https://mobirise.co/i">how to build a website for free</a></section><section class="header3 cid-qEt7xcetUd" id="header3-5x" data-rv-view="1246">
    ...
    <div class="container">
        <div class="media-container-row">
            ...
            <div class="media-content align-middle mt-2 pt-2 mt-lg-5 pt-lg-5" style="text-align: center;">
                <h1 class="mbr-section-title align-center mbr-bold pb-3 mbr-fonts-style display-1" style="text-shadow: 2px 2px #191919;">Municipal Distributions List</h1>
            </div>
        </div>
    </div>
...
<div id="custom-html-5z" custom-code="true" data-rv-view="561"><section style="background-color: #ffffff;">
    <div class="container" id="check_list">
        ...
        <?php require("c:/inetpub/libs/kansasstatetreasurer/lib_dist_list_body01.php"); ?>
    </div> <!-- container -->
</section>

</div>

<section class="testimonials4 cid-qEt7xdmFjH" id="testimonials4-60" data-rv-view="1249">
...
<section class="cid-qEt7xdRZEg" id="footer1-61" data-rv-view="1255">

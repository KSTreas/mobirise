<?php require("c:/inetpub/libs/kansasstatetreasurer/lib_request_claims_top01.php");  ?><!DOCTYPE html>
<html >
<head>
  ...
  <meta name="description" content="Request claim packets for located unclaimed properties from the Office of the Kansas State Treasurer.">
  <title>Request Claim Packets</title>
  ...
  <link rel="stylesheet" href="assets/css/request_claims.css"  type="text/css">
<script type="text/javascript" src="/jquery/jquery-3.2.1.min.js"></script>
<script type="text/javascript" src="assets/js/request_claims.js"></script>
</head>
<body>
<section class="menu cid-qCHUdL86bZ" once="menu" id="menu1-4j" data-rv-view="1193">
...
<section class="engine"><a href="https://mobirise.co/g">create your own website for free</a></section><section class="header3 cid-qDOZy0UhDT" id="header3-4k" data-rv-view="1195">
    ...
    <div class="container">
        <div class="media-container-row">
            ...
            <div class="media-content align-middle mt-2 pt-2 mt-lg-5 pt-lg-5" style="text-align: center;">
                <h1 class="mbr-section-title align-center mbr-bold pb-3 mbr-fonts-style display-1" style="text-shadow: 2px 2px #191919;">Request Claim Packets</h1>
            </div>
        </div>
    </div>
...
<section class="section-table cid-qDOZZ2UNzK" id="table1-4l" data-rv-view="1198">

  
  
  <div class="container container-table">
      <h2 class="mbr-section-title mbr-fonts-style align-center pb-md-3 display-2">Request Claim Packets&nbsp;</h2>
      <h3 class="mbr-section-subtitle mbr-fonts-style align-center pb-md-5 mbr-light display-5">This first step is paperless. &nbsp;For some properties there won't be anything else to do. &nbsp;We will send paperwork for the properties where we need more information.</h3>
    </div> <!-- container-table -->
</section>

<div id="custom-html-5n" custom-code="true" data-rv-view="511"><section style="background-color: #ffffff;">
...
<section class="mbr-section form1 cid-qDP2syR5Yv" id="form1-4m" data-rv-view="1201">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="media-container-column col-lg-8" data-form-type="formoid">
                    ...
                    <form class="mbr-form" action="https://mobirise.com/" method="post" data-form-title="Mobirise Form"><input type="hidden" data-form-email="true" value="2AXS/sRpDRM8XL68PejJ8Ub+FZmHcEX3eRTHBDH9ogzwwOQhMlJvIUH5VPE7okKFvwFyJFy5IkFxdn9SXu2Q9jpe3u+h+vECd0hvIzYR1u9M6hC4LZb5SxjpsGTfA0gm">
                        <div class="form-group" data-for="subjectList">
                            ...
                            <select name="subjectList" class="form-control" id="subjectList-form1-4m" data-form-field="Subject">
                        ...
                        <div class="row row-sm-offset">
                            <div class="col-md-4 multi-horizontal" data-for="name">
                                <div class="form-group">
                                    <label class="form-control-label mbr-fonts-style display-7" for="name-form1-4m">Name</label>
                                    <span class="_kst_text-required">( Required )</span>
                                    <input type="text" class="form-control" name="name" data-form-field="Name" required="" id="name-form1-4m">
                                </div>
                            </div>
                            <div class="col-md-4 multi-horizontal" data-for="email">
                                <div class="form-group">
                                    <label class="form-control-label mbr-fonts-style display-7" for="email-form1-4m">Email</label>
                                    <span class="_kst_text-required">( Required )</span>
                                    <input type="email" class="form-control" name="email" data-form-field="Email" required="" id="email-form1-4m">
                                </div>
                            </div>
                            <div class="col-md-4 multi-horizontal" data-for="phone">
                                <div class="form-group">
                                    <label class="form-control-label mbr-fonts-style display-7" for="phone-form1-4m">Phone</label>
                                    <span class="_kst_text-required">( Required )</span>
                                    <input type="tel" class="form-control" name="phone" data-form-field="Phone" id="phone-form1-4m">
                                </div>
                            </div>
                        </div>
                        <div class="form-group" data-for="message">
                            <label class="form-control-label mbr-fonts-style display-7" for="message-form1-4m">Message</label>
                            <span class="_kst_text-required">( Required )</span>
                            <textarea type="text" class="form-control" name="message" rows="7" data-form-field="Message" id="message-form1-4m"></textarea>
                        </div>
                        <div class="g-recaptcha" data-sitekey="6Ld4mzsUAAAAACXLktMZw4BRbZH2ZH3xwRRDxXgz"></div>
                        <span class="input-group-btn"><button href="" type="submit" class="btn btn-primary btn-form display-4">REQUEST PACKETS</button></span>
                    </form>
            </div>
        </div>
    </div>
...
<section class="testimonials4 cid-qDP32QA3cX" id="testimonials4-4n" data-rv-view="1204">
          ...
          <div class="testimonials-caption col-lg-9 col-md-8">
            ...
            <div class="user_text ">
              <p class="mbr-fonts-style  display-7">
                 <em>"We will make every attempt to approve your claim paperlessly. &nbsp;It is even possible to receive payment directly into your bank account. &nbsp;Our quick, efficient claim process was designed to save you time and money. &nbsp;You may also call us directly at 785-296-4165 for more personal assistance.</em><em>"</em> &nbsp;<a href="page2.html">Learn more about Jake</a>.</p>
            </div>
          </div>
        </div>
      </div></div>
...
<section class="cid-qDP3N9Nkgk" id="footer1-4o" data-rv-view="1210">

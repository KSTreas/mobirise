<?php require("c:/inetpub/libs/kansasstatetreasurer/lib_check_search_top01.php");  ?><!DOCTYPE html>
<html >
<head>
  ...
  <meta name="description" content="Find out the current status of a check issued by the State of Kansas.">
  <title>State Check Search</title>
  ...
  <link rel="stylesheet" href="assets/css/check_search.css"  type="text/css">
<script type="text/javascript" src="/jquery/jquery-3.2.1.min.js"></script>
<script type="text/javascript" src="assets/js/check_search.js"></script>

<script src='https://www.google.com/recaptcha/api.js'></script>
</head>
<body>
<section class="menu cid-qE5Vmb5Zcz" once="menu" id="menu1-53" data-rv-view="753">
...
<section class="engine"><a href="https://mobirise.co/g">create a website for free</a></section><section class="header3 cid-qE5VmcaheJ" id="header3-54" data-rv-view="755">
    ...
    <div class="container">
        <div class="media-container-row">
            ...
            <div class="media-content align-middle mt-2 pt-2 mt-lg-5 pt-lg-5" style="text-align: center;">
                <h1 class="mbr-section-title align-center mbr-bold pb-3 mbr-fonts-style display-1" style="text-shadow: 2px 2px #191919;">State Check <br>Status Search</h1>
            </div>
        </div>
    </div>
...
<section class="mbr-section form1 cid-qE5Vmdq6m7" id="form1-56" data-rv-view="758">
    ...
    <div class="container mt-0 mb-0 pb-0">
        <div class="row justify-content-center">
            <div class="title col-12 col-lg-8 mb-0 pb-0">
                
                <h3 class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-5">Enter a 7 or 10 digit number from the upper right-hand corner of a State of Kansas issued check.</h3>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row justify-content-center">
            <div class="media-container-column col-lg-10">
                    <form action="check_search.php" method="post" id="check_search_form">
                        <div class="row row-sm-offset justify-items-center">
                            <div class="col-md-3 multi-horizontal" data-for="ch_check_num">
                                <div class="form-group">
                                    <span class="_kst_text-required">*</span>
                                    <label class="form-control-label mbr-fonts-style display-7" for="ch_check_num">Check Number</label>
                                    <input type="text" class="form-control" name="frm_ch_check_num" value="<?php print (isset($_POST['frm_ch_check_num'])?$_POST['frm_ch_check_num']:""); ?>" size="12" data-form-field="Check Number" id="ch_check_num" required="">
                                </div>
                            </div>
...
<div id="custom-html-5o" custom-code="true" data-rv-view="532"><section style="background-color: #ffffff;">
    <div class="container" id="check_list">
        <?php require("c:/inetpub/libs/kansasstatetreasurer/lib_check_search_body01.php"); ?>
    </div> <!-- container -->
</section>

</div>

<section class="testimonials4 cid-qE5VmeNBNY" id="testimonials4-58" data-rv-view="761">
          ...
          <div class="testimonials-caption col-lg-9 col-md-8">
            ...
            <div class="user_text">
              <p class="mbr-fonts-style  display-7">
                 <em>"Even though we are making every effort to switch over to only electronic payments, the&nbsp;</em>State of Kansas still issues thousands of paper checks each year. &nbsp;This page can be used to check the current status of a check to ensure accuracy and validity.<em>"</em> &nbsp;<a href="page2.html">Learn more about Jake</a>.</p>
            </div>
          </div>
        </div>
      </div></div>
...
<section class="cid-qE5VmfygsK" id="footer1-59" data-rv-view="767">

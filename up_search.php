<?php require("c:/inetpub/libs/kansasstatetreasurer/lib_up_search_top01.php"); ?>
<!DOCTYPE html>
<html >
<head>
  ...
  <meta name="description" content="Enter your name to search the Kansas Unclaimed Property database.">
  <title>Unclaimed Property Search</title>
  ...
  <link rel="stylesheet" href="assets/css/up_search.css"  type="text/css">
<script type="text/javascript" src="/jquery/jquery-3.2.1.min.js"></script>
<script type="text/javascript" src="assets/js/up_search.js"></script>

<script src='https://www.google.com/recaptcha/api.js'></script>
</head>
<body>
<section class="menu cid-qCHUdL86bZ" once="menu" id="menu1-4c" data-rv-view="893">
...
<section class="engine"><a href="https://mobirise.co/i">how to build your own website for free</a></section><section class="header3 cid-qDJOzwSXYF" id="header3-4d" data-rv-view="895">
    ...
    <div class="container">
        <div class="media-container-row">
            ...
            <div class="media-content align-middle mt-2 pt-2 mt-lg-5 pt-lg-5" style="text-align: center;">
                <h1 class="mbr-section-title align-center mbr-bold pb-3 mbr-fonts-style display-1" style="text-shadow: 2px 2px #191919;">Search For Unclaimed Property</h1>
            </div>
        </div>
    </div>
...
<section class="mbr-section content8 cid-qDJOSfGbAb" id="content8-4e" data-rv-view="898">

    

    <div class="container">
        <div class="media-container-row title">
            <div class="col-12 _kst_cart-icon" style="">
                <a id="page_cart_icon" class="" href="request_claims.php">
                    <span class="mbri-shopping-cart mbr-iconfont mbr-iconfont-btn" aria-hidden="true"></span>
                    <span class="ml-1" id="itemsInCart-text" aria-hidden="true">0</span> 
                    <span class="sr-only" id="itemsInCart-aria">Request 0 Claim Packets</span>
                </a>
            </div>
        </div>
    </div>
...
<section class="mbr-section form1 cid-qDJPdMMSeO" id="form1-4f" data-rv-view="899">
    ...
    <div class="container mb-3 mb-md-0">
        <div class="row justify-content-center">
            <div class="media-container-column col-lg-10">
                    <form action="up_search.php?nwlst=1" method="post" id="up_search_form">
                        <div class="row row-sm-offset justify-items-center">
                            <div class="col-md-3 multi-horizontal" data-for="ow_last">
                                <div class="form-group">
                                    <span class="_kst_text-required">*</span>
                                    <label class="form-control-label mbr-fonts-style display-7" for="ow_last">Last Name</label>
                                    <input type="text" class="form-control" name="frm_ow_last" data-form-field="Last Name" id="ow_last" value="<?php print $_SESSION['up_search']['post']['frm_ow_last']; ?>" required="">
                                </div>
                            </div>
                            <div class="col-md-3 multi-horizontal" data-for="ow_first">
                                <div class="form-group">
                                    <label class="form-control-label mbr-fonts-style display-7" for="ow_first">First Name or Initial</label>
                                    <input type="text" class="form-control" name="frm_ow_first" id="ow_first" data-form-field="First Name" value="<?php print $_SESSION['up_search']['post']['frm_ow_first']; ?>">
                                </div>
                            </div>
                            <div class="col-md-3 multi-horizontal" data-for="ow_middle">
                                <div class="form-group">
                                    <label class="form-control-label mbr-fonts-style display-7" for="ow_middle">Middle Name or Initial</label>
                                    <input type="text" class="form-control" name="frm_ow_middle" id="ow_middle" data-form-field="Middle Name" value="<?php print $_SESSION['up_search']['post']['frm_ow_middle']; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row row-sm-offset justify-items-center">
                            <div class="col-md-3 multi-horizontal" data-for="ss_event">
                                <div class="form-group">
                                    <label class="form-control-label mbr-fonts-style display-7" for="ss_event">How did you hear about us?</label>
                                    <select class="form-control" name="frm_ss_event" id="ss_event" data-form-field="Event">
                                        <option value="online" selected="">Online Search</option>
                                        <option value="facebook">Face Book</option>
                                        <option value="twitter">Twitter</option>
                                        <option value="remote">Remote Event</option>
                            ...
                            <div class="col-md-3 multi-horizontal">
                                <input type="submit" name="submit_form" value="GO" class="btn _kst_btn-inline-go btn-sm btn-form" style="margin-top: 1.75rem;">
<!--                                <span mbr-buttons mbr-theme-style="display-3" data-toolbar="-mbrLink,-mbrBtnAdd,-mbrBtnMove" class="input-group-btn">
                                <a href="javascript:" onclick="search_up()" type="submit" class="btn _kst_btn-inline-go btn-md btn-form">GO</a></span>
-->
                            </div>
                        </div>
                    </form>
...
<div id="custom-html-5j" custom-code="true" data-rv-view="180"><section style="background-color: #ffffff;">
    ...
    <div class="container" id="prop_list">
        <?php require("c:/inetpub/libs/kansasstatetreasurer/lib_up_search_body01.php"); ?>
    </div> <!-- container -->
</section>

</div>

<section class="testimonials4 cid-qDJPEYYb7Z" id="testimonials4-4h" data-rv-view="902">
          ...
          <div class="testimonials-caption col-lg-9 col-md-8">
            ...
            <div class="user_text">
              <p class="mbr-fonts-style  display-7">
                 <em>"</em>We have over 300 million dollars in unclaimed property waiting for the rightful owner to find and claim. &nbsp;One of the best parts of being Treasurer is returning lost money to the people of Kansas. &nbsp;Use the fields at the top of the page to see if we have anything for you. &nbsp;You may also call us at 785-296-4165 for more personal assistance.<em>"</em> &nbsp;<a href="page2.html">Learn more about Jake</a>.</p>
            </div>
          </div>
        </div>
      </div></div>
...
<section class="cid-qDJPMi7iiz" id="footer1-4i" data-rv-view="908">
